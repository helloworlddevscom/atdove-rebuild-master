 ...
 */
class AtDoveOrganizationsCronEventSubscriber implements EventSubscriberInterface {
  ...
  public static function getSubscribedEvents(): array {
    return [
      HookEventDispatcherInterface::CRON => 'checkLegacyOrgs',
    ];
  }
   ...
   */
  public function checkLegacyOrgs(): void {
