...
namespace Drupal\atdove_opigno\Plugin\ActivityAnswer;
...
/**
 * Class AtDoveArticleActivityAnswer.
 *
 * @ActivityAnswer(
 *   id="atdove_article",
 * )
 */
class AtDoveArticleActivityAnswer extends ActivityAnswerPluginBase {
