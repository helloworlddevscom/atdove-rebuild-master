...
/**
 * Filters by the Job Category Taxonomy Vocabulary.
 *
 * @ingroup views_filter_handlers
 *
 * @ViewsFilter("job_cat_groups_views_filter")
 */
class JobCategoryViewsFilter extends ManyToOne {
...
/**
  ...
  public function query() {
    ...
    if (!empty($this->value) && (!empty(reset($this->value)))) {
      ...
      $configuration2 = [
        'table' => 'opigno_activity__field_job_category',
        'field' => 'entity_id',
      ...
      $this->query->addRelationship('opigno_activity__field_job_category', $join2, 'opigno_activity__field_opigno_quiz');
      // Job category selected value
      $this->query->addWhere('AND', 'opigno_activity__field_job_category.field_job_category_target_id', $this->value, 'IN');
    }
    else {
       parent::query();
    }
