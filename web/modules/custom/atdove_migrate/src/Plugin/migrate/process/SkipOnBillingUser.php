...
/**
 * @file
 * Contains \Drupal\atdove_migrate\Plugin\migrate\process\SkipOnBillingUser.
 *
 */
 ...
 *   id = "skip_on_billing_user"
 * )
 */
class SkipOnBillingUser extends ProcessPluginBase {
  ...
  public function row($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    if (stripos($value, 'billinguser')) {
      $message = !empty($this->configuration['message']) ? $this->configuration['message'] : 'Skipped Billing User';
